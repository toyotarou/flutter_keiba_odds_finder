...
class _AiAnalysisExplainAlertState extends ConsumerState<AiAnalysisExplainAlert> {
  static const String _markdownContent =
      ...
      '- **14頭以上** → 6頭を選出\n'
      '\n'
      '各選出馬には **おすすめ度**（100点満点）が付与されます。おすすめ度は、オッズ推移・単複比・断層・期待数値などを総合した信頼度の指標です。おすすめ度が高い順に表示されます。\n'
      '\n'
      '---\n'
      '\n'
      '## オッズ間断層とは\n'
      ...
      ' 1番(●人気) ○○○○○○  単勝: ●●.●倍→●●.●倍(上昇 +●●.●%)  複勝: ●●.●-●●.●倍(下落 ●●.●%)  単複比: ●.●倍\n'
      ' 2番(●人気) ○○○○○○  単勝: ●●.●倍→●●.●倍(下落 ●●.●%)  複勝: ●●.●-●●.●倍(上昇 +●●.●%)  単複比: ●.●倍\n'
      ' ...（出走頭数分続く）\n'
      '\n'
      '【●●●●mの過去●●●●レース統計】\n'
      ...
      '人気順はデータの表記をそのまま使用してください（AIが計算するものではありません）。\n'
      '\n'
      '選出馬は必ず以下の形式で●頭分出力し、おすすめ度の高い順に並べてください。\n'
      '─────────────────────────────\n'
      '馬番：●、馬名：○○○○○○、人気順: ●、6分前オッズ: ●●.●、おすすめ度: ●●、選出理由：〜〜〜〜〜〜〜〜（4〜5行の文章。箇条書き不要）\n'
      '─────────────────────────────\n'
      '```\n'
      '\n'
      '---\n'
