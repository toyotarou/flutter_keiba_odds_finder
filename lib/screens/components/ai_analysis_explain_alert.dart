...
class _AiAnalysisExplainAlertState extends ConsumerState<AiAnalysisExplainAlert> {
  static const List<String> _markdownContent = <String>[
      ...
      '',
      '- **タイプA（上位支配型）** → 1〜6番人気から最大4頭',
      '- **タイプB（断層1か所型）** → 最大7頭（1〜6番人気4頭・7〜10番人気2頭・11番〜1頭）',
      '- **タイプC（下位断層型）** → 最大7頭（1〜6番人気3頭・7〜10番人気3頭・11番〜1頭）',
      '- **タイプD（混戦型）** → 最大8頭（1〜6番人気3頭・7〜10番人気3頭・11番〜2頭）',
      '- **タイプE（単複乖離型）** → 最大7頭（1〜6番人気3頭・7〜10番人気3頭・11番〜1頭）',
      '',
      ...
      '- **タイプE**（単複矛盾型）: 単勝と複勝で断層位置が食い違う → 複勝の継続的な動きを最優先（最大7頭・中穴3頭・大穴1頭まで）',
      '',
      '---',
      '',
      '## OPIとは',
