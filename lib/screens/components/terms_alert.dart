...
import 'baganriki_index_explain_alert.dart';
...
class _TermsAlertState extends ConsumerState<TermsAlert> {
  static const List<String> _markdownContent = <String>[
    ...
    '## 第9条（アカウントの停止・削除）',
    '',
    '利用者が本規約に違反した場合、当サービスは事前通知なくアカウントの停止または削除をおこなう場合がございます。この場合、支払済みの料金の返金はいたしかねます。',
    '',
    '---',
    '',
    '## 第10条（免責事項）',
    ...
    '## 第14条（準拠法・管轄裁判所）',
    '',
    '本規約は日本法に準拠するものとし、本サービスに関して紛争が生じた場合は、当サービス運営者の所在地を管轄する裁判所を専属的合意管轄とします。',
  ];
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Material(
                        ...
                        borderRadius: BorderRadius.circular(10),
                        child: InkWell(
                          onTap: () => OddsFinderDialog(context: context, widget: const BaganrikiIndexExplainAlert()),
                          borderRadius: BorderRadius.circular(10),
                          splashColor: Colors.white.withValues(alpha: 0.2),
                          highlightColor: Colors.white.withValues(alpha: 0.1),
                          child: Container(
                            ...
                            child: const Text('馬眼力指数について', style: TextStyle(fontSize: 10)),
                          ),
                        ),
                      ),
                    ],
